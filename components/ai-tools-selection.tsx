...
const aiTools = [
  {
    ...
    name: "ChatGPT",
    description:
      "Ideal for text generation, customer support automation, and content creation",
  },
  {
    id: "claude",
    name: "Claude AI",
    description:
      "Advanced language model for complex analysis and code assistance",
  },
  {
    id: "midjourney",
    name: "Midjourney",
    ...
    <Card className="border border-neutral-800 bg-black">
      <CardHeader className="border-b border-neutral-800">
        <CardTitle className="text-xl font-semibold text-neutral-50">
          AI Tools You Use or Want to Explore
        </CardTitle>
        <CardDescription className="text-neutral-400">
          Check any AI solutions you're currently using or curious about. Not
          sure? Select what you've heard of or skip to let us recommend later.
        </CardDescription>
      </CardHeader>
